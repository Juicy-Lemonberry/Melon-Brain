...
const HorizontalBlogCard= () => {
  return (
  <>
	    <div className="bg-white text-black	border border-zinc-950	 "  style={{marginTop:30 }}>
      <div className="container grid grid-cols-12 mx-auto dark:bg-white">
        <div
          ...
          style={{
            backgroundImage: "url('https://cdn-prod.medicalnewstoday.com/content/images/articles/279/279176/a-close-up-of-a-sliced-cantaloupe-on-a-blue-table.jpg')",
